...
function App() {
  return (
    <div className="bg-slate-900 min-h-screen w-full flex flex-col items-center justify-center">
      ...
      <p className="text-slate-100 text-xs w-96 text-center mt-2">
        Ao se inscrever, você passará a receber os nossos e-mails com as melhores dicas, novidade e ofertas.
      </p>
    </div>
  )
}
